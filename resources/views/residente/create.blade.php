    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                <form method="POST" action="{{ url('residentes') }}">
                @csrf
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="casa_id" type="Number" class="form-control @error('casa_id') is-invalid @enderror" name="casa_id" value="{{ old('casa_id') }}" required  autofocus>
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="identification" type="text" class="form-control @error('identification') is-invalid @enderror" name="identification" value="{{ old('identification') }}" required  autofocus>
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="type_id" class="form-control" name="type_id" value="{{ old('type_id') }}" required  autofocus>
                 ...
                 <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cell" type="text" class="form-control @error('cell') is-invalid @enderror" name="cell" value="{{ old('cell') }}" required  autofocus>
